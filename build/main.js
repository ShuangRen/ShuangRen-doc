...
/***/ function(module, exports, __webpack_require__) {
	...
	router.map({
	    ...
	    '/view/*any': {
	        name: 'view', //详情
	        component: function component(resolve) {
	            !/* require */(/* empty */function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(11)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.call(this));
	        }
	    },
	    '/codelist': {
	        name: 'codelist', //详情
	...
	router.start(_main2.default, '#my-app');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configApi = __webpack_require__(10);

	var _configApi2 = _interopRequireDefault(_configApi);

	var _apiView = __webpack_require__(11);

	var _apiView2 = _interopRequireDefault(_apiView);

	var _leftView = __webpack_require__(22);
	...
	exports.default = {
	    ...
	    components: {
	        'api-view': _apiView2.default,
	        'left-view': _leftView2.default
	    },
	    created: function created() {
	        var that = this;
	        that.apiConf = _configApi2.default;
	    },

	    methods: {
	        onShowApiList: function onShowApiList() {
	            this.leftShow = true;
	        },
	        onCloseLeft: function onCloseLeft() {
	            this.leftShow = false;
	        },
	        onInclude: function onInclude(item) {
	            this.apiData = {};
	            var apiUrl = './api' + '/api.' + item + '.js';

	            var apiModule = __webpack_require__(27)(apiUrl);
	            var apiModuleList = {};
	            for (var v in apiModule) {
	                apiModuleList[v] = apiModule[v];
	            }

	            this.apiData = apiModuleList;
	            var list = {};
	            for (var _v in this.apiData.req) {
	                list[_v] = '';
	            }
	            this.inputData = list;
	        }
	    ...
	    events: {
	        leftShowMsg: function leftShowMsg(msg) {
	            this.leftShow = msg;
	        },
	        leftItem: function leftItem(msg) {
	            this.onInclude(msg);
	        }
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/view/apiView.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./apiView.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./apiView.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".apiView_wrap {\n  width: 80%;\n  overflow: hidden;\n  margin: 0 auto;\n  padding-top: 40px;\n}\n.pre {\n  width: 75%;\n  overflow: hidden;\n  padding: 25px 0;\n  background: #F5F5F5;\n  border: 1px solid #dcdcdc;\n  border-radius: 4px;\n  text-align: left;\n  padding-left: 5%;\n  line-height: 24px;\n}\n.pre_4 {\n  margin-left: 20px;\n  display: inline-block;\n}\n.pre_3 {\n  margin-left: 15px;\n  display: inline-block;\n}\n.top_req {\n  overflow: hidden;\n  background: #fff;\n  border-top: 5px solid #2196f3;\n  border-radius: 4px;\n  padding: 25px;\n  margin-bottom: 30px;\n  box-shadow: 0 0 10px #999;\n}\n.top_req .name {\n  font-size: 24px;\n  font-weight: 100;\n}\n.top_req .title {\n  font-size: 18px;\n  color: #999;\n}\n.top_req .page-header {\n  font-size: 18px;\n  font-weight: 100;\n  margin: 25px 0 10px;\n}\n.top_req .req_table {\n  width: 80%;\n  border: 1px solid #dcdcdc;\n  border-collapse: collapse;\n  border-spacing: 0;\n  margin-top: 20px;\n}\n.top_req .req_table tr {\n  width: 100%;\n}\n.top_req .req_table tr td {\n  border: 1px solid #dcdcdc;\n  height: 36px;\n  text-indent: 25px;\n}\n.middle_req {\n  border-top: 5px solid #4caf50;\n}\n.middle_req .inputtext {\n  width: 60%;\n  height: 40px;\n  line-height: 40px;\n  border: 1px solid #dcdcdc;\n  border-radius: 4px;\n  text-indent: 10px;\n}\n.middle_req .page-header {\n  margin-top: 10px;\n  padding-bottom: 20px;\n  border-bottom: 1px solid #dcdcdc;\n  margin-bottom: 30px;\n  font-size: 24px;\n  color: #333;\n}\n.middle_req .form-head {\n  font-weight: 100;\n  font-size: 16px;\n  color: #666;\n  margin: 15px 0 5px;\n}\n.middle_req .send_btn {\n  width: 100px;\n  height: 40px;\n  line-height: 40px;\n  text-align: center;\n  color: #fff;\n  background: #4caf50;\n  border: none;\n  border-radius: 4px;\n  margin-top: 20px;\n  cursor: pointer;\n}\n.middle_req .send_btn:hover {\n  background: #2E8932;\n}\n.middle_req .send_btn:active {\n  background: #155D18;\n}\n.bottom_req {\n  border-top: 5px solid #ffeb3b;\n}\n.bottom_req .pre {\n  background: #fff;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    route: {
	        canReuse: false },
	    created: function created() {
	        var anyArr = this.$route.params.any.split('/');
	    ...
	    attached: function attached() {
	        var that = this;
	        setTimeout(function () {
	            that.items.res = (0, _stringify2.default)(that.items.res, null, 4);
	        }, 100);
	    },

	    methods: {
	        apiSend: function apiSend() {
	            var that = this;
	            _request2.default.request(that.items.methods, that.items.title, that.inputdata, function (res) {
	                that.requresItem = (0, _stringify2.default)(res, null, 4);
	            }, function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configMain = __webpack_require__(20);

	var _configMain2 = _interopRequireDefault(_configMain);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = {
	    request: function request(methods, apiurl, data, Fn, errFn) {
	        var that = this;
	        var url = _configMain2.default.domain + (_configMain2.default.public ? _configMain2.default.public : '') + apiurl;

	        _http2.default.ajax(methods, url, data, _configMain2.default.headers).then(function (error, res) {
	            if (error) {
	                errFn && errFn(error);
	            } else {
	                if (that.isJson(res)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/view/leftView.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./leftView.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./leftView.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".left_warp {\n  width: 400px;\n  height: 100%;\n  overflow-y: auto;\n  background: #fff;\n  z-index: 2;\n  position: absolute;\n  left: 0;\n  top: 0;\n  box-shadow: 0 0 15px #333;\n  -webkit-transform: translateX(-100%);\n  transform: translateX(-100%);\n  -webkit-transition: all .1s;\n}\n.left_warp .textInput {\n  width: 92%;\n  height: 40px;\n  border: 1px solid #dcdcdc;\n  border-radius: 4px;\n  line-height: 40px;\n  text-indent: 10px;\n  color: #333;\n  margin: 20px auto;\n  display: block;\n}\n.left_warp ul {\n  width: 100%;\n  overflow: hidden;\n}\n.left_warp ul li {\n  width: 92%;\n  height: auto;\n  min-height: 52px;\n  padding-bottom: 10px;\n  margin: 0 auto;\n  border-bottom: 1px solid #e3e3e3;\n  cursor: pointer;\n}\n.left_warp ul li p {\n  font-size: 16px;\n  line-height: 30px;\n  color: #333;\n}\n.left_warp ul li span {\n  font-size: 14px;\n  color: #999;\n}\n.left_warp.showActive {\n  -webkit-transform: translateX(0);\n  transform: translateX(0);\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        onSelectApi: function onSelectApi(key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./api/api.getcatelist": 28,
		"./api/api.getcatelist.js": 28,
		"./api/api.getlist": 29,
